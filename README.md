...
1. **Clone Repository**: Clone this repository to your local machine using the following command:
    ```bash
    git clone https://github.com/kasunmadhuranga/GitHub-Docker-and-Jenkins-CI-CD-Pipeline.git
    ```
...
4. **Configure Pipeline**: In Jenkins, create a new pipeline job and configure it to use the provided `Jenkinsfile` in this repository. in pipeline script I added password text file 
